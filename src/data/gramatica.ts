...
export const gramatica: GrammarPoint[] = [
  {
    title: "〜は",
    explanation:
      "Partícula de tópico, indica o assunto da frase. O que vem antes de は é o tópico sobre o qual se fala.",
  ...
  },
  {
    title: "〜です",
    explanation:
      "Verbo copulativo formal, usado para afirmar ou descrever algo. Equivalente ao 'ser' ou 'estar' em português.",
  ...
  },
  {
    title: "〜ですか",
    explanation:
      "Partícula de pergunta, transforma uma frase afirmativa em interrogativa. Equivale ao ponto de interrogação.",
    pattern: "Sentença + か",
    level: "N5",
    examples: [
      {
  ...
  },
  {
    title: "〜の",
    explanation:
      "Partícula de posse/pertencimento, indica que o segundo substantivo pertence ou está relacionado ao primeiro. Também pode ligar substantivos para formar uma ideia composta.",
  ...
  },
  {
    title: "これ/それ/あれ",
    explanation:
      "Pronomes demonstrativos: これ (isto, perto do falante), それ (isso, perto do ouvinte), あれ (aquilo, longe de ambos).",
  ...
  },
  {
    title: "この/その/あの",
    explanation:
      "Determinantes demonstrativos: この (este), その (esse), あの (aquele). Sempre vêm antes de um substantivo.",
  ...
  },
  {
    title: "〜に",
    explanation:
      "Partícula que indica localização (existência), direção ou ponto no tempo. Usado com verbos de existência (あります/います) e movimento.",
  ...
  },
  {
    title: "あります/います",
    explanation:
      "Verbos de existência: あります (para objetos inanimados) e います (para seres vivos). Indicam que algo existe ou está em um determinado local.",
  ...
  },
  {
    title: "〜と",
    explanation:
      "Partícula que significa 'e' (para listar substantivos) ou 'com' (para indicar companhia).",
  ...
  },
  {
    title: "〜も",
    explanation:
      "Partícula que significa 'também' ou 'nem' (em frases negativas). Expressa inclusão ou exclusão.",
  ...
  },
  {
    title: "〜を",
    explanation:
      "Partícula de objeto direto, marca o objeto de um verbo transitivo. Indica o que recebe a ação do verbo.",
  ...
  },
  {
    title: "〜へ",
    explanation:
      "Partícula que indica direção ou destino. É sinônimo de に quando se refere a movimento para um local.",
  ...
  },
  {
    title: "〜で",
    explanation:
      "Partícula que indica o local onde uma ação ocorre ou o meio/instrumento utilizado para a ação.",
  ...
  },
  {
    title: "〜から〜まで",
    explanation:
      "Partículas que indicam 'de ... até ...'. Usadas para especificar um ponto de partida e um ponto final (no espaço ou tempo).",
  ...
  },
  {
    title: "〜ね",
    explanation:
      "Partícula de final de frase que busca confirmação ou concorda com o ouvinte, criando um tom amigável. Equivalente a 'né?' ou 'não é mesmo?'.",
    pattern: "Sentença + ね",
    level: "N5",
    examples: [
      {
  ...
  },
  {
    title: "〜よ",
    explanation:
      "Partícula de final de frase que enfatiza ou fornece uma nova informação ao ouvinte. Equivalente a 'Eu te digo' ou 'Olha só'.",
    pattern: "Sentença + よ",
    level: "N5",
    examples: [
      {
  ...
  },
  {
    title: "〜ませんか",
    explanation:
      "Usado para fazer um convite ou sugestão. É uma forma educada de perguntar 'por que não fazemos isso?'",
  ...
  },
  {
    title: "〜ましょう",
    explanation:
      "Usado para fazer uma sugestão ou para expressar uma intenção de fazer algo junto com o ouvinte. Significa 'vamos fazer'.",
  ...
  },
  {
    title: "〜ながら",
    explanation:
      "Indica que duas ações estão acontecendo simultaneamente, sendo a ação principal a que vem depois de ながら.",
  ...
  },
  {
    title: "〜たり〜たり します",
    explanation:
      "Lista algumas ações típicas que ocorrem, sem necessariamente listar todas ou em ordem cronológica.",
  ...
  },
  {
    ...
    pattern:
      "Adjetivo い (sem い) + くなります / Adjetivo な (sem な) + に なります / Substantivo + に なります",
    level: "N5",
    examples: [
      {
        jp: "寒くなりました。",
  ...
  },
  {
    ...
    explanation:
      "Expressa ações de dar (あげます), receber (もらいます) e alguém dar para o falante (くれます).",
    pattern:
      "A + は/が + B + に + Substantivo + を あげます (A dá para B) / A + は/が + B + に/から + Substantivo + を もらいます (A recebe de B) / B + が + 私 + に + Substantivo + を くれます (B dá para mim)",
    level: "N5",
    examples: [
      {
        jp: "私は友達に本をあげました。",
  ...
  },
  {
    title: "〜から",
    explanation:
      "Indica o ponto de partida de um movimento ou a origem de algo. Também pode indicar a causa ou razão.",
  ...
  },
  {
    title: "〜が",
    explanation:
      "Conjunção que significa 'mas' ou 'e', conectando duas orações, muitas vezes com contraste ou adicionando informações.",
  ...
  },
  {
    ...
    explanation:
      "A partícula が é usada para indicar o objeto de verbos de desejo, preferência, habilidade ou posse.",
  ...
  },
  {
    ...
    explanation:
      "A partícula を marca o objeto direto de um verbo transitivo, indicando o alvo da ação.",
    pattern: "substantivo + を + verbo transitivo",
    level: "N5",
    examples: [
      {
  ...
  },
  {
    ...
    explanation:
      "A partícula で indica o meio, instrumento ou método pelo qual uma ação é realizada.",
  ...
  },
  {
    title: "〜と (e, e)",
    explanation:
      "A partícula と é usada para listar substantivos de forma exaustiva, significando 'e'.",
  ...
  },
  {
    title: "〜へ (direção)",
    explanation:
      "A partícula へ (lê-se 'e') é usada para indicar a direção ou destino de um movimento. É intercambiável com に na maioria dos casos, mas へ enfatiza mais a direção.",
  ...
  },
  {
    title: "〜しか〜ない",
    explanation:
      "Expressa a ideia de 'só isso/aquilo e nada mais', indicando limitação. Geralmente usado com verbos na forma negativa.",
  ...
  },
  {
    title: "〜やすい / 〜にくい",
    explanation:
      "〜やすい significa 'fácil de fazer'. 〜にくい significa 'difícil de fazer' ou 'complicado'.",
  ...
  },
  {
    title: "〜ている",
    explanation:
      "Indica uma ação contínua (estou fazendo), um estado resultante (estou casado), ou uma ação habitual (trabalho lá).",
  ...
  },
  {
    title: "〜てから",
    explanation:
      "Indica uma sequência de eventos, significando 'depois de fazer algo'. A segunda ação ocorre após a primeira ser completamente finalizada.",
  ...
  },
  {
    title: "〜たり〜たりする",
    explanation:
      "Lista algumas ações como exemplos de um conjunto maior de ações que são feitas ou aconteceram. Significa 'fazer coisas como... e...'.",
  ...
  },
  {
    title: "〜つもりです",
    explanation:
      "Expressa intenção ou plano futuro. Significa 'pretendo fazer...' ou 'tenho a intenção de fazer...'.",
  ...
  },
  {
    ...
    pattern:
      "Verbo na forma 'ta' (para conselho positivo) ou Verbo na forma negativa simples (para conselho negativo) + ほうがいい",
    level: "N5",
    examples: [
      {
        jp: "早く寝たほうがいいですよ。",
  ...
  },
  {
    title: "〜でしょう / 〜だろう",
    explanation:
      "Expressa probabilidade, suposição ou confirmação. でしょう é mais formal que だろう.",
  ...
  },
  {
    title: "〜と思います",
    explanation:
      "Expressa a opinião ou pensamento do falante. Significa 'Eu acho que...' ou 'Eu penso que...'.",
  ...
  },
  {
    title: "〜ないでください",
    explanation:
      "Pede para alguém não fazer algo de forma educada. É uma forma de proibição ou pedido negativo.",
  ...
  },
  {
    title: "〜なかった",
    explanation:
      "Forma passada da negação de verbos (e adjetivos 'i'), significando 'não fiz' ou 'não era'.",
  ...
  },
  {
    title: "〜なくてはいけません",
    explanation:
      "Indica uma obrigação ou necessidade, significando 'ter que fazer...' ou 'deve-se fazer...'.",
  ...
  },
  {
    title: "〜なくてもいいです",
    explanation:
      "Indica que não há necessidade de fazer algo, significando 'não precisa fazer...' ou 'não é necessário fazer...'.",
  ...
  },
  {
    title: "〜ので",
    explanation:
      "Similar a 'から', mas um pouco mais formal e menos direto, dando uma razão. Geralmente usado em situações onde você está explicando algo.",
    pattern:
      "Sentença (forma simples para verbos/adjetivos i, +na para adjetivos na/substantivos) + ので",
    level: "N5",
    examples: [
      {
        jp: "電車が遅れたので、遅刻しました。",
  ...
  },
  {
    title: "〜たり〜たりします",
    explanation:
      "Lista algumas ações típicas entre várias, implicando que outras ações também podem ocorrer. Significa 'fazer isso e aquilo'.",
  ...
  },
  {
    title: "〜方",
    explanation:
      "Significa 'o modo de fazer' ou 'como fazer'. Usado para descrever um método ou maneira.",
  ...
  },
  {
    title: "〜しか〜ません",
    explanation:
      "Significa 'apenas', 'somente'. Sempre usado com um verbo na forma negativa, enfatizando a exclusividade.",
  ...
  },
  {
    ...
    explanation:
      "Expressa que algo parece ser de certa forma, com base na observação. Significa 'parece que'.",
  ...
  },
  {
    ...
    explanation:
      "Usado para relatar informações que foram ouvidas de outra pessoa. Significa 'disseram que' ou 'ouvi dizer que'.",
  ...
  },
  {
    title: "〜でしょう (pergunta)",
    explanation:
      "Usado para confirmar algo que o falante acredita ser verdade, esperando concordância. Significa 'não é?' ou 'certo?'.",
  ...
  },
  {
    title: "〜とき",
    explanation:
      "Significa 'quando' ou 'na época em que X'. Descreve o momento em que algo acontece.",
  ...
  },
  {
    title: "〜たら",
    explanation:
      "Expressa uma condição hipotética ou sequencial. 'Se X, então Y' ou 'Depois que X, Y'.",
  ...
  },
  {
    title: "〜なら",
    explanation:
      "Usado para dar conselhos ou fazer uma pergunta baseada em uma informação anterior. 'Se for o caso de X, então Y'.",
  ...
  },
  {
    title: "〜間に",
    explanation:
      "Significa 'enquanto X' ou 'durante X'. Indica que algo acontece enquanto outra coisa está em andamento.",
  ...
  },
  {
    title: "〜し",
    explanation:
      "Lista razões ou fatos que contribuem para uma conclusão ou situação. 'E além disso...' ou 'Não só... como também...'.",
  ...
  },
  {
    title: "〜でしょう",
    explanation:
      "Usado para expressar suposição ou pedir confirmação educadamente. 'Não é?' ou 'Provavelmente'.",
  ...
  },
  {
    ...
    explanation:
      "Indica o estágio de uma ação. 〜ているところだ (fazendo agora), 〜たところだ (acabou de fazer), 〜ところだ (prestes a fazer).",
  ...
  },
  {
    title: "〜ばかり",
    explanation:
      "Indica que algo acabou de acontecer ou que algo é a única coisa que está sendo feita. 'Acabei de fazer X' ou 'Só X'.",
  ...
  },
  {
    title: "〜はずだ",
    explanation:
      "Expressa expectativa forte ou suposição baseada em evidências. 'Deve ser X' ou 'É para ser X'.",
  ...
  },
  {
    title: "〜方 (かた)",
    explanation:
      "Indica o 'modo' ou 'maneira' de fazer algo. Ex.: modo de cozinhar, forma de usar.",
  ...
  },
  {
    title: "〜ようになる",
    explanation:
      "Indica uma mudança no estado ou habilidade, 'passar a fazer', 'tornar-se capaz de fazer'.",
  ...
  },
  {
    title: "〜ようにする",
    explanation:
      "Expressa um esforço para fazer ou não fazer algo, 'tentar fazer', 'procurar fazer'.",
  ...
  },
  {
    title: "〜間に (あいだに)",
    explanation:
      "Significa 'enquanto' ou 'durante', indicando que algo acontece em um período de tempo.",
  ...
  },
  {
    title: "〜そうです (様態)",
    explanation:
      "Indica que algo 'parece' de determinada forma com base na observação visual. Não se usa com い形容詞 e な形容詞 que descrevem aparência (e.g. きれい, いい).",
    pattern:
      "動詞ます形 (ますを削除) + そうです / い形容詞 (いを削除) + そうです / な形容詞 (なを削除) + そうです",
    level: "N4",
    examples: [
      {
        jp: "このケーキは美味しそうです。",
  ...
  },
  {
    title: "〜そう（です）",
    explanation:
      "Expressa que algo 'parece' ou 'ao que tudo indica' possui certa característica ou vai acontecer, baseado em observação.",
    pattern:
      "adjetivo-i (sem o い) + そう; adjetivo-na (sem o な) + そう; verbo (forma-masu, sem o masu) + そう",
    level: "N4",
    examples: [
      {
        jp: "このケーキは美味しそうです。",
  ...
  },
  {
    title: "〜てみる",
    explanation:
      "Significa 'tentar fazer algo' ou 'fazer algo para ver o que acontece', expressando uma experimentação.",
  ...
  },
  {
    title: "〜てしまう",
    explanation:
      "Indica que uma ação foi concluída completamente (com sentimento de finalização ou arrependimento) ou aconteceu inesperadamente.",
  ...
  },
  {
    title: "〜前に (まえに)",
    explanation:
      "Indica que uma ação ocorre 'antes de' outra, estabelecendo uma ordem cronológica.",
  ...
  },
  {
    title: "〜た後で (たあとで)",
    explanation:
      "Significa 'depois de' ou 'após', indicando que uma ação ocorre após a conclusão de outra.",
  ...
  },
  {
    title: "〜だろう / 〜でしょう",
    explanation:
      "Expressa conjectura ou probabilidade, significando 'provavelmente', 'deve ser' ou 'eu me pergunto'. でしょう é mais formal.",
    pattern:
      "verbo (forma simples) + だろう/でしょう; substantivo + だろう/でしょう; adjetivo-i + だろう/でしょう; adjetivo-na + だろう/でしょう",
    level: "N4",
    examples: [
      {
        jp: "明日は雨が降るだろう。",
  ...
  },
  {
    ...
    explanation:
      "Usado para confirmar uma informação ou buscar a concordância do ouvinte, geralmente com uma entonação crescente.",
    pattern:
      "verbo (forma simples) + でしょう; substantivo + でしょう; adjetivo-i + でしょう; adjetivo-na + でしょう",
    level: "N4",
    examples: [
      {
        jp: "これはあなたの本でしょう？",
  ...
  },
  {
    ...
    explanation:
      "Usado para fazer uma sugestão ou convite de forma educada, com um tom de 'que tal fazermos X?'.",
  ...
  },
  {
    ...
    pattern:
      "verbo (forma simples) + かもしれない; substantivo + かもしれない; adjetivo-i + かもしれない; adjetivo-na + かもしれない",
    level: "N4",
    examples: [
      {
        jp: "明日は雨が降るかもしれません。",
  ...
  },
  {
    ...
    explanation:
      "てあげる: X faz algo por Y (X a Y); てくれる: X faz algo por Y (Y agradece X); てもらう: Y recebe uma ação de X (Y recebe de X).",
  ...
  },
  {
    title: "〜と (condicional)",
    explanation:
      "Indica uma condição que, se cumprida, leva a um resultado certo ou natural, como uma regra ou fato.",
  ...
  },
  {
    title: "〜てある",
    explanation:
      "Indica que uma ação foi realizada e seu resultado permanece em um estado presente. Sugere uma preparação ou propósito.",
  ...
  },
  {
    title: "〜ておく",
    explanation:
      "Significa 'fazer algo com antecedência para um propósito futuro', 'deixar algo em um determinado estado' ou 'fazer algo e deixar como está'.",
  ...
  },
  {
    title: "〜はず（だ）",
    explanation:
      "Significa 'deve ser' ou 'é esperado que seja', expressando uma forte expectativa ou convicção baseada em alguma informação ou razão.",
    pattern:
      "Verbo [forma simples] + はずだ / い-Adjetivo + はずだ / な-Adjetivo + なはずだ / Substantivo + のはずだ",
    level: "N4",
    examples: [
      {
        jp: "彼はもうすぐ来るはずです。",
  ...
  },
  {
    title: "〜の間に / 〜間に",
    explanation:
      "Significa 'enquanto' ou 'durante'. Indica que algo acontece em um período de tempo em que outra ação ou estado está ocorrendo.",
    pattern:
      "Verbo [forma simples] + 間に / い-Adjetivo + 間に / な-Adjetivo + な間に / Substantivo + の間に",
    level: "N4",
    examples: [
      {
  ...
  },
  {
    ...
    explanation:
      "Expressa que um substantivo específico é 'fácil/difícil de' ser afetado por um verbo.",
  ...
  },
  {
    title: "〜ようとする",
    explanation:
      "Significa 'tentar fazer algo' ou 'estar prestes a fazer algo'. Implica um esforço ou intenção.",
  ...
  },
  {
    title: "〜つもり（だ）",
    explanation:
      "Expressa a intenção ou plano do falante. Significa 'pretendo' ou 'tenho a intenção de'.",
    pattern:
      "Verbo [forma simples] + つもりだ / な-Adjetivo + なつもりだ / Substantivo + のつもりだ",
    level: "N4",
    examples: [
      {
        jp: "来年、日本へ行くつもりです。",
  ...
  },
  {
    title: "〜予定（だ）",
    explanation:
      "Expressa um plano ou agendamento definido. Significa 'está programado para' ou 'há um plano de'.",
  ...
  },
  {
    title: "〜のに",
    explanation:
      "Expressa uma ideia de 'apesar de' ou 'embora', indicando uma contradição ou um resultado inesperado. Também pode ser usado para expressar surpresa ou queixa.",
    pattern:
      "Verbo [forma simples] + のに / い-Adjetivo + のに / な-Adjetivo + なのに / Substantivo + なのに",
    level: "N4",
    examples: [
      {
  ...
  },
  {
    title: "〜までに",
    explanation:
      "Indica um prazo ou limite de tempo para que uma ação seja concluída. A ação deve ser feita antes desse tempo.",
    pattern: "N + までに",
    level: "N4",
    examples: [
      {
  ...
  },
  {
    title: "〜そうだ (伝聞)",
    explanation:
      "Indica que o falante ouviu falar de algo. É usado para reportar informações que foram obtidas de terceiros.",
  ...
  },
  {
    title: "〜そうだ (様態)",
    explanation:
      "Indica que algo parece ser de uma certa maneira, com base na aparência visual ou em uma impressão imediata. Não pode ser usado para descrever sensações internas.",
  ...
  },
  {
    title: "〜らしい",
    explanation:
      "Expressa uma conjectura baseada em evidências, indicando que algo parece ser, ou é típico de, uma determinada coisa ou pessoa.",
  ...
  },
  {
    ...
    explanation:
      "Expressa conjectura ou suposição do falante, de forma mais polida que 'だろう'. Também pode ser usado para buscar confirmação.",
  ...
  },
  {
    title: "〜でしょ (coloquial)",
    explanation:
      "É a forma coloquial de 'でしょう', usada para buscar confirmação de forma mais informal.",
  ...
  },
  {
    title: "〜はずがない",
    explanation:
      "Expressa uma forte negação, indicando que algo é impossível ou altamente improvável. 'Não tem como'.",
    pattern:
      "V (forma simples) + はずがない; いA + はずがない; なA + なはずがない; N + のはずがない",
    level: "N4",
    examples: [
      {
  ...
  },
  {
    title: "〜がる",
    explanation:
      "Usado para descrever a emoção ou o desejo de uma terceira pessoa, quando observável por seu comportamento ou expressão. Não pode ser usado com o próprio falante.",
  ...
  },
  {
    ...
    explanation:
      "Compara uma coisa a outra, indicando semelhança. 'ようだ' é como um adjetivo-na, 'ように' é como um advérbio, 'のような' modifica um substantivo.",
  ...
  },
  {
    title: "〜だろう・でしょう",
    explanation:
      "Expressa probabilidade ou conjectura sobre algo, similar a 'deve ser' ou 'provavelmente'. ですでしょう é mais formal que だろう.",
    pattern:
      "verbo/i-adjetivo (forma simples) + だろう・でしょう | na-adjetivo/substantivo + だろう・でしょう",
    level: "N4",
    examples: [
      {
        jp: "明日は雨が降るだろう。",
  ...
  },
  {
    title: "〜すぎる",
    explanation:
      "Indica que algo é 'demais', 'excessivo' ou 'em excesso'. Pode ser negativo ou positivo dependendo do contexto.",
    pattern:
      "verbo (forma masu sem masu) + すぎる | i-adjetivo (sem い) + すぎる | na-adjetivo (sem な) + すぎる",
    level: "N4",
    examples: [
      {
        jp: "このケーキは甘すぎる。",
  ...
  },
  {
    title: "〜やすい・にくい",
    explanation:
      "やす(い) indica que algo é 'fácil de fazer' ou 'propenso a', enquanto にく(い) indica que é 'difícil de fazer' ou 'resistente a'.",
  ...
  },
  {
    title: "〜みたいだ",
    explanation:
      "Indica similaridade ou aparência. 'Parece que', 'é como se', 'tipo'. Pode ser usado para comparações ou para expressar incerteza.",
    pattern:
      "verbo/i-adjetivo (forma simples) + みたいだ | na-adjetivo (sem な) + みたいだ | substantivo + みたいだ",
    level: "N4",
    examples: [
      {
        jp: "この猫は犬みたいだ。",
  ...
  },
  {
    title: "〜んです・のです",
    explanation:
      "Usado para explicar, dar uma razão ou para buscar uma explicação. Adiciona ênfase e um tom de investigação ou justificação.",
    pattern:
      "verbo/i-adjetivo (forma simples) + んです・のです | na-adjetivo (sem な) + なんです・なのです | substantivo + なんです・なのです",
    level: "N4",
    examples: [
      {
        jp: "どうして遅れたんですか。",
  ...
  },
  {
    title: "〜予定だ",
    explanation:
      "Indica um plano ou programação, algo que está 'previsto' ou 'agendado'. Mais formal que つもりだ.",
  ...
  },
  {
    title: "〜ことになる",
    explanation:
      "Indica que algo foi decidido por outros ou por circunstâncias, não pela própria vontade. 'Ficou decidido que', 'acabou por ser'.",
  ...
  },
  {
    title: "〜ように・〜になる",
    explanation:
      "Indica uma mudança de estado ou habilidade. 〜ようになる significa 'se tornar capaz de fazer', 〜になる significa 'se tornar (adjetivo/substantivo)'.",
    pattern:
      "verbo (forma potencial) + ように・〜になる | substantivo + になる | adjetivo + になる",
    level: "N4",
    examples: [
      {
        jp: "日本語が話せるようになりました。",
  ...
  },
  {
    title: "〜ようだ / 〜みたいだ",
    explanation:
      "Significa 'parece que', 'como se', 'tal como'. Indica uma semelhança ou uma suposição baseada em observação.",
    pattern:
      "Verbo/Adjetivo (Plain form) + ようだ / みたいだ; Substantivo + の + ようだ / みたいだ",
    level: "N3",
    examples: [
      {
        jp: "彼は日本人ではないようだ。",
  ...
  },
  {
    title: "〜ことになっている",
    explanation:
      "Indica uma regra, um costume, um plano fixo ou uma decisão tomada por outros ou por um grupo. Significa 'está decidido que'.",
  ...
  },
  {
    title: "〜あいだに",
    explanation:
      "Significa 'enquanto', 'durante o período em que'. Uma ação ocorre dentro de um período em que outra coisa está acontecendo.",
  ...
  },
  {
    ...
    explanation:
      "Significa 'a não ser que (faça X), não (pode fazer Y)'. Indica uma condição necessária para a ação posterior.",
  ...
  },
  {
    title: "〜ところだ",
    explanation:
      "Indica o momento exato em que uma ação ocorre: 'acabar de fazer', 'estar prestes a fazer' ou 'estar fazendo no momento'.",
  ...
  },
  {
    title: "〜ばかりに",
    explanation:
      "Significa 'apenas porque', 'justamente porque'. Indica que uma causa levou a um resultado negativo inesperado ou indesejado.",
  ...
  },
  {
    title: "〜ものだから / 〜もので",
    explanation:
      "Usado para dar uma razão ou desculpa de forma mais informal e com um tom um pouco mais suave do que 'から' ou 'ので'.",
    pattern:
      "Verbo/Adjetivo (Plain form) + ものだから / もので; Substantivo + な + ものだから / もので",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜ていく",
    explanation:
      "Indica uma ação que se afasta do falante, uma mudança gradual ou a continuidade de uma ação para o futuro.",
    pattern: "動詞のて形 + いく",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜てくる",
    explanation:
      "Indica uma ação que se aproxima do falante, uma mudança gradual que ocorre até o presente ou a continuidade de uma ação desde o passado até o presente.",
    pattern: "動詞のて形 + くる",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜うちに",
    explanation:
      "Significa 'enquanto' ou 'antes que', indicando que algo deve ser feito enquanto uma condição específica ainda existe, ou que algo inesperado acontece durante um período.",
  ...
  },
  {
    title: "〜ところ",
    explanation:
      "Indica o momento exato em que uma ação está prestes a começar (辞書形), está em andamento (ている形) ou acabou de terminar (た形).",
  ...
  },
  {
    title: "〜にとって",
    explanation:
      "Indica o ponto de vista ou a perspectiva de alguém/algo. Significa 'para' ou 'em relação a'.",
  ...
  },
  {
    title: "〜として",
    explanation:
      "Indica a função, papel ou posição de alguém/algo. Significa 'como' ou 'na qualidade de'.",
  ...
  },
  {
    title: "〜だけでなく〜も",
    explanation:
      "Significa 'não só... mas também...', indicando que algo se aplica a mais de uma coisa.",
  ...
  },
  {
    title: "〜わけだ",
    explanation:
      "Usado para explicar a razão lógica ou a consequência óbvia de algo. Significa 'é por isso que', 'significa que'.",
  ...
  },
  {
    title: "〜わけがない",
    explanation:
      "Expressa forte negação ou descrença, indicando que algo é impossível ou inconcebível. Significa 'não há como', 'é impossível que'.",
  ...
  },
  {
    title: "〜というより",
    explanation:
      "Usado para corrigir ou refinar uma afirmação, indicando que a segunda opção é mais precisa. Significa 'mais do que', 'em vez de dizer que'.",
  ...
  },
  {
    title: "〜ということだ",
    explanation:
      "Usado para resumir ou parafrasear uma informação, ou para expressar uma conclusão. Significa 'significa que', 'entendi que'.",
  ...
  },
  {
    title: "〜によると／〜では",
    explanation:
      "Usado para citar a fonte de uma informação, significando 'de acordo com' ou 'segundo'.",
  ...
  },
  {
    title: "〜さえ〜ば",
    explanation:
      "Expressa uma condição mínima necessária para que algo aconteça, significando 'se apenas... então...'.",
    pattern:
      "Substantivo + さえ + 動詞ば形 / い形容詞 + ければ / な形容詞 + ならば / 動詞 (ます形) + さえすれば",
    level: "N3",
    examples: [
      {
        jp: "お金さえあれば、何でも買える。",
  ...
  },
  {
    title: "〜というのは",
    explanation:
      "Usado para definir ou explicar um termo ou conceito. Significa 'o que X significa é'.",
  ...
  },
  {
    title: "〜たびに",
    explanation:
      "Indica que algo acontece sempre que outra coisa ocorre. Significa 'toda vez que'.",
  ...
  },
  {
    title: "〜ば〜ほど",
    explanation:
      "Indica que quanto mais uma coisa acontece, mais a outra também ocorre. Significa 'quanto mais... mais...'.",
    pattern:
      "動詞ば形 + 動詞辞書形 + ほど / い形容詞 + ければ + い形容詞 + ほど / な形容詞 + ならば + な形容詞 + なほど",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜ほど",
    explanation:
      "Usado para expressar um grau ou extensão, significando 'tanto quanto', 'ao ponto de'. Também pode ser usado em comparações para expressar 'quanto mais...'.",
  ...
  },
  {
    title: "〜まま",
    explanation:
      "Indica que uma ação ou estado permanece inalterado. Significa 'como está', 'sem mudar'.",
    pattern:
      "動詞 (た形) + まま / 動詞 (ない形) + まま / い形容詞 + まま / な形容詞 + な + まま / Substantivo + の + まま",
    level: "N3",
    examples: [
      {
        jp: "靴を履いたまま家に入った。",
  ...
  },
  {
    title: "〜ことになった",
    explanation:
      "Indica que uma decisão ou um plano foi estabelecido por terceiros ou por uma situação. Significa 'ficou decidido que', 'foi determinado que'.",
  ...
  },
  {
    ...
    pattern:
      "動詞 (た形) + ままにする / 動詞 (ない形) + ままにする / い形容詞 + ままにする / な形容詞 + な + ままにする / Substantivo + の + ままにする",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜によって／により",
    explanation:
      "Indica o agente (por meio de), o método (através de), a causa (devido a) ou a variação (dependendo de).",
  ...
  },
  {
    title: "〜はずがない／わけがない",
    explanation:
      "Expressa uma forte negação ou descrença, significando 'não há como', 'é impossível' ou 'não é provável'.",
    pattern:
      "Verbo (forma simples) + はずがない／わけがない\nAdjetivo い + はずがない／わけがない\nAdjetivo な (omitindo な) + なはずがない／なわけがない\nSubstantivo + のはずがない／なわけがない",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜わけにはいかない",
    explanation:
      "Indica que, por alguma razão (moral, social, etc.), não se pode fazer algo, significando 'não posso fazer (algo)' ou 'não devo fazer (algo)'.",
  ...
  },
  {
    title: "〜ないわけにはいかない",
    explanation:
      "Indica que, por alguma razão, é preciso fazer algo, significando 'não posso deixar de fazer (algo)' ou 'é preciso fazer (algo)'.",
  ...
  },
  {
    title: "〜ことだ",
    explanation:
      "Usado para dar conselhos ou sugestões, significando 'o melhor é fazer (algo)' ou 'deve-se fazer (algo)'.",
  ...
  },
  {
    title: "〜ことがある／こともある",
    explanation:
      "Indica que algo acontece ocasionalmente ou é uma possibilidade, significando 'às vezes (acontece)' ou 'pode acontecer'.",
  ...
  },
  {
    title: "〜ようだ／みたいだ",
    explanation:
      "Expressa uma suposição baseada em evidências ou uma comparação, significando 'parece que', 'aparentemente' ou 'como se'.",
    pattern:
      "Verbo (forma dit.) + ようだ／みたいだ\nAdjetivo い + ようだ／みたいだ\nAdjetivo な + なようだ／みたいだ\nSubstantivo + のようだ／みたいだ",
    level: "N3",
    examples: [
      {
        jp: "彼は疲れているようだ。",
  ...
  },
  {
    ...
    explanation:
      "Modifica um substantivo, indicando semelhança ou exemplo, significando 'como (um) ...', 'parecido com (um) ...' ou 'tipo de...'.",
    pattern:
      "Verbo (forma dit.) + ような／みたい な + Substantivo\nAdjetivo い + ような／みたい な + Substantivo\nAdjetivo な + なような／みたいな + Substantivo\nSubstantivo + のような／みたいな + Substantivo",
    level: "N3",
    examples: [
      {
        jp: "彼は太陽のような明るい人です。",
  ...
  },
  {
    ...
    explanation:
      "Indica que algo é feito ou se comporta de uma maneira que é típica ou característica de algo, significando 'de forma característica', 'tipicamente'.",
  ...
  },
  {
    title: "〜ばかりでなく",
    explanation:
      "Significa 'não só... mas também', indicando que algo não é apenas de uma maneira, mas também de outra.",
    pattern:
      "Verbo (forma dit.) + ばかりでなく\nAdjetivo い + ばかりでなく\nAdjetivo な + なばかりでなく\nSubstantivo + ばかりでなく",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜一方だ",
    explanation:
      "Indica que algo está em um estado de mudança contínua e unidirecional, significando 'estar cada vez mais' ou 'continuar a (fazer/ser)'.",
  ...
  },
  {
    title: "〜どころではない",
    explanation:
      "Indica que não é o momento ou a situação apropriada para fazer algo, ou que algo está muito longe de ser verdade.",
  ...
  },
  {
    title: "〜どころか",
    explanation:
      "Expressa que o oposto do que foi esperado ou sugerido é verdade, ou que a situação é ainda mais extrema, significando 'muito pelo contrário', 'longe de' ou 'nem sequer'.",
    pattern:
      "Verbo (forma dit.) + どころか\nAdjetivo い + どころか\nAdjetivo な (omitindo な) + どころか\nSubstantivo + どころか",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜につれて／にしたがって",
    explanation:
      "Indica que, à medida que uma coisa muda, outra também muda, significando 'à medida que' ou 'conforme'.",
  ...
  },
  {
    title: "〜に対して",
    explanation:
      "Expressa uma relação de oposição ou contraste, ou indica o alvo de uma ação ou sentimento.",
    pattern: "名詞 + に対して",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜から〜にかけて",
    explanation:
      "Indica um período de tempo ou uma extensão espacial que vai de um ponto a outro de forma aproximada.",
  ...
  },
  {
    title: "〜を始め",
    explanation:
      "Significa 'começando por X', indicando que X é um exemplo representativo de um grupo maior.",
    pattern: "名詞 + を始め",
    level: "N3",
    examples: [
      {
        ...
        romaji:
          "Kono mise de wa yasai o hajime, sakana ya niku nado samazama na shokuzai ga te ni hairu.",
  ...
  },
  {
    title: "〜にもかかわらず",
    explanation:
      "Significa 'apesar de' ou 'não obstante', expressando que uma situação inesperada ocorreu apesar de algo.",
    pattern:
      "普通形 + にもかかわらず (な形容詞: であるにもかかわらず / 名詞: であるにもかかわらず)",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜限り",
    explanation:
      "Expressa uma condição de 'enquanto' ou 'enquanto houver', indicando que uma situação continuará sob uma determinada condição.",
  ...
  },
  {
    title: "〜といえば",
    explanation:
      "Usado para mudar de assunto, introduzir um tópico relacionado ou expressar uma associação quando algo é mencionado.",
    pattern: "名詞 / 普通形 + といえば",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に決まっている",
    explanation:
      "Expressa uma forte convicção de que algo é definitivamente verdade ou acontecerá, sem dúvida.",
  ...
  },
  {
    title: "〜とみられる",
    explanation:
      "Significa 'é considerado que' ou 'parece que', usado para expressar uma conclusão baseada em evidências, mas sem total certeza (comumente em notícias).",
  ...
  },
  {
    title: "〜に応じて",
    explanation:
      "Significa 'de acordo com' ou 'em resposta a', indicando que algo muda ou é feito conforme uma determinada condição.",
    pattern: "名詞 + に応じて",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜において",
    explanation:
      "Significa 'em' ou 'no que diz respeito a', usado para indicar local, tempo ou domínio de uma ação ou situação (mais formal que で ou に).",
    pattern: "名詞 + において",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に伴って",
    explanation:
      "Significa 'junto com' ou 'à medida que', indicando que uma coisa acontece em conjunto ou como consequência de outra.",
  ...
  },
  {
    title: "〜によって",
    explanation:
      "Indica o agente de uma ação passiva, o meio ou método, a causa ou a variação dependendo da situação.",
    pattern: "名詞 + によって",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に基づいて",
    explanation:
      "Significa 'baseado em' ou 'fundamentado em', indicando que algo é feito ou decidido com base em certos princípios ou fatos.",
    pattern: "名詞 + に基づいて",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜かねない",
    explanation:
      "Expressa a preocupação de que algo negativo ou indesejável possa acontecer, 'pode vir a...'.",
    pattern: "動詞ます形 + かねない",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜てばかり",
    explanation:
      "Indica que uma ação é feita repetidamente ou que a pessoa só faz aquilo. Pode ter um sentido negativo de excesso.",
    pattern: "動詞のて形＋ばかり",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜てばかりいる",
    explanation:
      "Enfatiza a continuidade de uma ação repetitiva ou exclusiva, com uma conotação de tédio, irritação ou surpresa.",
    pattern: "動詞のて形＋ばかりいる",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜てやる",
    explanation:
      "Expressa que o falante faz algo para alguém ou um animal de nível inferior ou para quem não se tem muito respeito, ou para um amigo íntimo.",
    pattern: "動詞のて形＋やる",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜とか",
    explanation:
      "Usado para listar exemplos não exaustivos, significando 'e coisas do tipo' ou 'como... ou...'.",
  ...
  },
  {
    title: "〜とのこと",
    explanation:
      "Forma mais casual de relatar uma informação, como 'ouvi dizer que...' ou 'fui informado que...'.",
    pattern: "普通形＋とのこと",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜として〜ない",
    explanation:
      "Expressa a ideia de 'nem um(a) sequer' ou 'não há nada como'. Enfatiza a ausência completa de algo.",
  ...
  },
  {
    title: "〜にあたって",
    explanation:
      "Usado para indicar uma ocasião ou momento importante, significando 'ao/para (fazer algo)' ou 'no momento de'. Mais formal que 〜時に.",
  ...
  },
  {
    title: "〜に加えて",
    explanation:
      "Significa 'além de' ou 'em adição a'. Usado para adicionar um elemento a uma lista ou situação existente.",
  ...
  },
  {
    title: "〜に代わって / 〜にかわって",
    explanation:
      "Significa 'em vez de', 'no lugar de' ou 'em nome de'. Indica uma substituição de pessoa ou coisa.",
    pattern: "名詞＋に代わって",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に関して",
    explanation:
      "Significa 'a respeito de', 'em relação a' ou 'sobre'. Usado para indicar o tópico ou assunto.",
    pattern: "名詞＋に関して",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に際して",
    explanation:
      "Usado para indicar uma ocasião ou momento importante, geralmente formal. Significa 'ao/para (fazer algo)' ou 'no momento de'. Similar a にあたって.",
  ...
  },
  {
    title: "〜だけでなく",
    explanation:
      "Expressa que algo não é apenas uma coisa, mas também outra. Significa 'não só... mas também'.",
  ...
  },
  {
    title: "〜はずがない / 〜わけがない",
    explanation:
      "Expressa a impossibilidade ou improbabilidade de algo. Significa 'não há como', 'não é possível que'.",
  ...
  },
  {
    title: "〜ことはない",
    explanation:
      "Indica que não é necessário fazer algo. Significa 'não precisa', 'não é necessário'.",
  ...
  },
  {
    title: "〜Nに対して",
    explanation:
      "Compara duas coisas ou ideias, contrastando-as. Significa 'enquanto', 'ao passo que'.",
  ...
  },
  {
    title: "〜に対して (〜にたいして)",
    explanation:
      "Indica o alvo ou o objeto em relação ao qual uma ação, atitude ou sentimento é direcionado. Pode significar 'em relação a', 'para com' ou 'contra'.",
    pattern: "substantivo + に対して",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    title: "〜に比べて (〜にくらべて)",
    explanation:
      "Usado para fazer uma comparação, indicando que algo é diferente ou tem uma característica diferente em relação a outro. Significa 'em comparação com'.",
    pattern: "substantivo + に比べて",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    ...
    explanation:
      "Significa 'em vez de', 'no lugar de', 'em substituição a'. Indica que algo ou alguém substitui outro.",
  ...
  },
  {
    title: "〜に応じて (〜におうじて)",
    explanation:
      "Significa 'de acordo com', 'em conformidade com', 'em resposta a'. Indica que algo muda ou é feito de acordo com uma situação ou condição.",
  ...
  },
  {
    title: "〜に沿って (〜にそって)",
    explanation:
      "Significa 'ao longo de', 'seguindo', 'de acordo com'. Usado para indicar que uma ação ou plano segue uma linha, regra ou instrução.",
  ...
  },
  {
    title: "〜をめぐって (〜をめぐって)",
    explanation:
      "Significa 'em torno de', 'em relação a', 'sobre'. Usado para indicar que um debate, controvérsia ou evento gira em torno de um determinado assunto.",
  ...
  },
  {
    ...
    explanation:
      "Indica um intervalo aproximado de tempo ou espaço, significando 'de ... a ...' ou 'entre ... e ...'.",
  ...
  },
  {
    ...
    explanation:
      "Indica que algo se estende por toda uma área ou período de tempo. Significa 'por toda', 'ao longo de', 'durante'.",
  ...
  },
  {
    ...
    explanation:
      "Indica um meio ou método pelo qual algo é realizado, ou que algo se estende por um período. Significa 'através de', 'por meio de', 'durante todo'.",
  ...
  },
  {
    title: "〜限り (〜かぎり)",
    explanation:
      "Significa 'enquanto', 'enquanto houver', 'até o limite de'. Indica uma condição ou limite.",
    pattern:
      "verbo (forma do dicionário/ない形) + 限り, substantivo + の限り, adjetivo い + 限り, adjetivo な + な限り",
    level: "N3",
    examples: [
      {
  ...
  },
  {
    ...
    explanation:
      "Significa 'apenas para', 'somente para', 'exclusivamente para'. Indica uma restrição ou exceção.",
  ...
  },
  {
    title: "〜に加えて (〜にくわえて)",
    explanation:
      "Significa 'além de', 'em adição a', 'juntamente com'. Usado para adicionar um elemento a algo que já existe.",
  ...
  },
  {
    title: "〜とともに (〜とともに)",
    explanation:
      "Significa 'junto com', 'ao mesmo tempo que', 'à medida que'. Pode indicar companhia ou mudança simultânea.",
  ...
  },
  {
    ...
    explanation:
      "Indica que uma mudança ocorre em paralelo com outra. Significa 'à medida que', 'conforme'.",
  ...
  },
  {
    ...
    explanation:
      "Indica que algo acontece junto com outro evento ou mudança. Significa 'acompanhado por', 'com', 'devido a'.",
  ...
  },
  {
    title: "〜につれて (〜につれて)",
    explanation:
      "Expressa que à medida que algo muda, outra coisa também muda em consequência. Significa 'à medida que', 'conforme'.",
  ...
  },
  {
    ...
    explanation:
      "Indica que algo acontece antes de outro evento importante ou oficial. Significa 'antes de', 'em preparação para'.",
  ...
  },
  {
    ...
    explanation:
      "Indica o momento ou ocasião em que algo importante acontece. Significa 'no momento de', 'ao fazer'.",
  ...
  },
  {
    title: "〜に対して / 〜に対し",
    explanation:
      "Expressa que algo é feito 'em relação a' ou 'em contraste com' outra coisa. Pode indicar direção, alvo ou contraste.",
    pattern: "名詞 + に対して / に対し",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜っけ",
    explanation:
      "Usado para recordar ou confirmar algo que se esqueceu ou para pedir uma confirmação casual. É uma forma informal.",
  ...
  },
  {
    title: "〜ものだ / 〜ものではない",
    explanation:
      "Expressa uma regra geral, um senso comum, um conselho ou uma lembrança nostálgica. 'ものではない' indica algo que não se deve fazer.",
  ...
  },
  {
    title: "〜につれて / 〜にしたがって",
    explanation:
      "Expressa que uma mudança acontece progressivamente em conjunto com outra. Quanto mais (A), mais (B) acontece.",
  ...
  },
  {
    title: "〜とともに",
    explanation:
      "Significa 'junto com' ou 'ao mesmo tempo que'. Pode indicar que duas coisas acontecem simultaneamente ou que uma acontece em associação com a outra.",
  ...
  },
  {
    title: "〜かねる",
    explanation:
      "Expressa que é difícil ou impossível fazer algo, geralmente devido a motivos emocionais ou éticos, apesar da vontade de fazê-lo. É uma forma educada de recusar.",
  ...
  },
  {
    title: "〜得る / 〜得ない",
    explanation:
      "Significa 'é possível fazer' (得る) ou 'não é possível fazer' (得ない). Indica a possibilidade ou impossibilidade de algo.",
  ...
  },
  {
    title: "〜に基づいて / 〜に基づき",
    explanation:
      "Significa 'baseado em' ou 'fundamentado em'. Indica que algo é feito ou estabelecido com base em uma fundação, regra ou dado.",
  ...
  },
  {
    title: "〜にわたって / 〜にわたり",
    explanation:
      "Indica que algo se estende por toda uma determinada área, período de tempo ou gama. Significa 'por todo', 'ao longo de' ou 'durante'.",
  ...
  },
  {
    title: "〜をめぐって / 〜をめぐる",
    explanation:
      "Significa 'em torno de', 'em relação a' ou 'sobre'. Indica que um debate, discussão ou evento acontece tendo um determinado tópico ou questão como centro.",
  ...
  },
  {
    title: "〜からには",
    explanation:
      "Significa 'já que', 'uma vez que'. Expressa que, dado uma determinada condição, uma certa ação ou responsabilidade é natural ou esperada.",
  ...
  },
  {
    ...
    explanation:
      "Significa 'não posso/devo fazer (por motivos internos ou externos)' ou 'não posso evitar fazer (por motivos externos)'. Expressa uma impossibilidade moral, social ou prática.",
  ...
  },
  {
    title: "〜を抜きにしては",
    explanation:
      "Significa 'sem (isso), não seria possível'. Expressa que uma determinada coisa é indispensável para que outra aconteça ou exista.",
    pattern: "名詞 + を抜きにしては",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を始め / 〜をはじめとして",
    explanation:
      "Significa 'começando por', 'incluindo' ou 'especialmente'. Apresenta um exemplo representativo de uma lista de itens ou pessoas.",
  ...
  },
  {
    title: "〜に限り / 〜に限って",
    explanation:
      "Significa 'somente para', 'apenas no caso de'. Restringe uma ação ou situação a um grupo ou circunstância específica.",
    pattern: "名詞 + に限り / に限って",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜に他ならない",
    explanation:
      "Significa 'nada mais é do que', 'não é outra coisa senão'. Enfatiza que algo é verdade e não há outra explicação ou causa.",
    pattern: "名詞 + に他ならない",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ばかりか",
    explanation:
      "Significa 'não apenas... mas também'. Indica que algo não é apenas de uma maneira, mas também de outra, adicionando algo inesperado ou ainda mais significativo.",
  ...
  },
  {
    title: "〜はもちろん / 〜はもとより",
    explanation:
      "Significa 'claro que' ou 'nem se fala de'. Indica que algo é óbvio, e além disso, outra coisa também é verdadeira ou válida.",
  ...
  },
  {
    title: "〜にしたがって",
    explanation:
      "Indica seguir uma ordem, instrução ou regra. Significa 'de acordo com' ou 'seguindo'.",
  ...
  },
  {
    title: "〜に反して",
    explanation:
      "Significa 'ao contrário de' ou 'em oposição a'. Indica que algo é o oposto do esperado ou do que foi dito.",
    pattern: "名詞＋に反して",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を問わず",
    explanation:
      "Significa 'independentemente de' ou 'não importa'. Indica que algo se aplica a todos, sem distinção.",
    pattern: "名詞＋を問わず",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜にかかわらず",
    explanation:
      "Significa 'independentemente de' ou 'não importa'. Semelhante a 〜を問わず, mas com foco em opções ou escolhas.",
    pattern: "名詞＋にかかわらず",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を通して / 〜を通じて",
    explanation:
      "Significa 'através de' ou 'por meio de'. Indica que algo é feito ou acontece usando um meio ou canal.",
  ...
  },
  {
    title: "〜に限らず",
    explanation:
      "Significa 'não apenas' ou 'não limitado a'. Indica que algo não se restringe a um determinado caso, mas se aplica mais amplamente.",
    pattern: "名詞＋に限らず",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜にわたって",
    explanation:
      "Significa 'por toda a' ou 'ao longo de'. Indica que algo se estende por uma ampla área, período de tempo ou gama.",
    pattern: "名詞＋にわたって",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜というものだ",
    explanation:
      "Expressa uma conclusão, um julgamento ou uma opinião forte sobre algo, muitas vezes com um tom de surpresa ou crítica.",
    pattern: "普通形＋というものだ",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜というものでもない",
    explanation:
      "Expressa que uma afirmação não é totalmente verdade, nem se aplica a todas as situações. Significa 'não é que seja necessariamente'.",
  ...
  },
  {
    title: "〜に越したことはない",
    explanation:
      "Significa que é melhor que algo aconteça ou que algo esteja em um determinado estado, mas não é uma obrigação.",
  ...
  },
  {
    title: "〜といったところだ",
    explanation:
      "Indica que algo está em um certo nível ou grau, geralmente um nível médio ou máximo esperado.",
    pattern: "名詞＋といったところだ",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜といったらない",
    explanation:
      "Expressa um grau extremo de algo, além da descrição ou imaginação. Geralmente usado com sentimentos negativos.",
  ...
  },
  {
    title: "〜を禁じ得ない",
    explanation:
      "Significa que não se pode conter uma emoção ou sentimento, geralmente riso, lágrimas ou surpresa.",
    pattern: "名詞＋を禁じ得ない",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜にたる",
    explanation:
      "Significa que algo é digno de, ou merecedor de. (Forma mais formal que 〜に値する)",
  ...
  },
  {
    title: "〜の至り",
    explanation:
      "Expressa o auge ou o extremo de um sentimento ou estado, geralmente positivo e formal.",
    pattern: "名詞＋の至り",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜の極み",
    explanation:
      "Expressa o auge ou o extremo de um sentimento ou estado, geralmente negativo e formal.",
    pattern: "名詞＋の極み",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜をものともせず",
    explanation:
      "Significa que alguém faz algo sem se importar ou ser incomodado por uma dificuldade ou obstáculo.",
    pattern: "名詞＋をものともせず",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜をよそに",
    explanation:
      "Significa que alguém age independentemente da situação ou dos sentimentos dos outros, sem se importar.",
    pattern: "名詞＋をよそに",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ではあるまいし",
    explanation:
      "Significa 'não é como se fosse...' ou 'não é como se...'. Expressa a ideia de que algo não é adequado porque a situação não é como se pensa.",
  ...
  },
  {
    title: "〜にかまけて",
    explanation:
      "Significa estar tão ocupado ou absorvido em algo que negligencia outras coisas importantes.",
    pattern: "名詞＋にかまけて",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜をおいてほかにない",
    explanation:
      "Significa 'não há outro além de...' ou 'o único...'. Expressa que a pessoa ou coisa é a única adequada para algo.",
  ...
  },
  {
    title: "〜なくしては",
    explanation:
      "Significa 'sem... não se pode...' ou 'sem... não seria possível...'. Expressa que algo é indispensável para outra coisa.",
    pattern: "名詞＋なくしては",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ずにはおかない",
    explanation:
      "Significa que algo certamente acontecerá ou que alguém certamente fará algo, por influência ou inevitabilidade.",
  ...
  },
  {
    title: "〜に足りる",
    explanation:
      "Significa que algo é suficiente para, ou que algo vale a pena. (Mais comum que 〜にたる)",
  ...
  },
  {
    title: "〜といえども",
    explanation:
      "Significa 'mesmo que seja...' ou 'ainda que...'. Indica que, apesar de uma condição, o resultado é o contrário do esperado ou esperado de outra forma.",
  ...
  },
  {
    title: "〜ばかりだ",
    explanation:
      "Indica uma tendência contínua de piora, similar a 一方だ, mas geralmente com um sentido mais negativo.",
    pattern: "動詞辞書形＋ばかりだ",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜と同時に",
    explanation:
      "Significa 'ao mesmo tempo que' ou 'juntamente com', indicando que duas ações ou estados ocorrem simultaneamente.",
  ...
  },
  {
    title: "〜かわりに",
    explanation:
      "Significa 'em vez de' ou 'em troca de', indicando uma substituição ou um sacrifício por algo.",
  ...
  },
  {
    title: "〜に沿って",
    explanation:
      "Significa 'ao longo de' ou 'de acordo com', indicando que algo segue uma linha, um plano ou uma regra.",
    pattern: "名詞＋に沿って",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ないこともない",
    explanation:
      "Significa 'não é que não seja' ou 'não é impossível', indicando uma possibilidade fraca ou uma concessão.",
    pattern: "動詞ない形＋こともない",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ないではいられない",
    explanation:
      "Significa 'não consigo evitar fazer' ou 'tenho que fazer', expressando uma forte necessidade ou desejo de fazer algo.",
  ...
  },
  {
    title: "〜ざるを得ない",
    explanation:
      "Significa 'não ter escolha a não ser fazer' ou 'ser obrigado a fazer', indicando uma ação que precisa ser tomada por força de circunstâncias.",
  ...
  },
  {
    title: "〜ものだから",
    explanation:
      "Porque (razão para uma desculpa ou justificação). Usado para explicar a razão de algo, muitas vezes com um tom de desculpa ou justificativa.",
  ...
  },
  {
    title: "〜ものがある",
    explanation:
      "Há algo (de um certo sentimento ou característica). Expressa a existência de um certo sentimento ou característica em algo.",
  ...
  },
  {
    title: "〜ことか / 〜ことだろう",
    explanation:
      "Quão (enfatiza um sentimento forte). Usado para expressar um sentimento forte de admiração, surpresa, emoção, etc.",
  ...
  },
  {
    title: "〜ことだから",
    explanation:
      "Porque (é uma pessoa ou coisa como tal). Usado para expressar uma suposição ou inferência com base no caráter ou natureza de alguém/algo.",
    pattern: "名詞＋のことだから",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ことなく",
    explanation:
      "Sem fazer (algo). Expressa que uma ação foi realizada sem a ocorrência de outra ação.",
    pattern: "動詞の辞書形＋ことなく",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ものの",
    explanation:
      "Embora (mas). Indica uma concessão, ou seja, que algo é verdade, mas há uma ressalva ou um resultado inesperado.",
  ...
  },
  {
    title: "〜ものなら",
    explanation:
      "Se fosse possível (gostaria de fazer). Expressa um desejo forte de fazer algo, sabendo que é difícil ou impossível.",
    pattern: "動詞の可能形＋ものなら",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜かと思うと / 〜かと思ったら",
    explanation:
      "Assim que (imediatamente depois). Indica que uma ação ou evento acontece imediatamente após outro, muitas vezes de forma inesperada.",
  ...
  },
  {
    title: "〜か〜ないかのうちに",
    explanation:
      "Mal (mal tinha feito algo quando...). Expressa que uma ação mal foi concluída quando outra ação ou evento ocorreu quase simultaneamente.",
  ...
  },
  {
    title: "〜のみならず",
    explanation:
      "Não só (mas também). Semelhante a 〜ばかりか, mas com um tom um pouco mais formal. Indica que algo é verdade, e ainda mais, outra coisa também é verdade.",
  ...
  },
  {
    title: "〜はおろか",
    explanation:
      "Nem mesmo (muito menos). Indica que uma coisa óbvia não é possível, então outra coisa menos provável é ainda mais impossível.",
    pattern: "名詞＋はおろか",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ようがない / 〜ようもない",
    explanation:
      "Não há como (fazer algo). Indica que não há um método, maneira ou possibilidade de realizar uma ação.",
  ...
  },
  {
    title: "〜に至る",
    explanation:
      "Significa 'chegar a um ponto' ou 'culminar em'. Indica que uma situação progrediu até um certo estágio.",
    pattern: "動辞書形／名 ＋ に至る",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜にかかわる",
    explanation:
      "Significa 'estar relacionado a' ou 'afetar'. Indica que algo tem uma ligação importante com outra coisa.",
    pattern: "名 ＋ にかかわる",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜にしろ／にせよ",
    explanation:
      "Significa 'quer seja... quer seja...' ou 'mesmo que'. Usado para apresentar duas ou mais possibilidades, indicando que o resultado é o mesmo independentemente da escolha.",
  ...
  },
  {
    title: "〜に過ぎない",
    explanation:
      "Significa 'não passar de' ou 'meramente'. Expressa que algo é apenas um certo grau ou quantidade, sem maior importância.",
  ...
  },
  {
    title: "〜に基づき／に基づいて",
    explanation:
      "Significa 'baseado em' ou 'de acordo com'. Indica a base ou fundamento para uma ação ou julgamento.",
  ...
  },
  {
    title: "〜にほかならない",
    explanation:
      "Significa 'não é nada além de' ou 'nada mais do que'. Usado para enfatizar a verdadeira natureza de algo.",
    pattern: "名 ＋ にほかならない",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を込めて",
    explanation:
      "Significa 'com' ou 'cheio de'. Indica que uma ação é realizada com um certo sentimento ou emoção.",
    pattern: "名 ＋ を込めて",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を機に",
    explanation:
      "Significa 'aproveitando a oportunidade de' ou 'tomando algo como ponto de partida'. Indica que algo é usado como gatilho para uma nova ação.",
    pattern: "名 ＋ を機に",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を皮切りに",
    explanation:
      "Significa 'começando com' ou 'tendo como ponto de partida'. Indica o primeiro item de uma série de eventos semelhantes.",
    pattern: "名 ＋ を皮切りに",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を最中に",
    explanation:
      "Significa 'no meio de' ou 'no auge de'. Indica que algo acontece durante a ocorrência de outra coisa, muitas vezes de forma inesperada.",
  ...
  },
  {
    title: "〜を境に",
    explanation:
      "Significa 'a partir de' ou 'desde'. Indica um ponto de virada após o qual algo muda significativamente.",
    pattern: "名 ＋ を境に",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜といい〜といい",
    explanation:
      "Significa 'tanto... quanto...' ou 'seja... seja...'. Usado para apresentar dois ou mais exemplos que ilustram uma característica comum.",
    pattern: "名 ＋ といい ＋ 名 ＋ といい",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜とあいまって",
    explanation:
      "Significa 'juntamente com' ou 'em combinação com'. Indica que dois ou mais fatores se combinam para produzir um resultado.",
    pattern: "名 ＋ とあいまって",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜とばかりに",
    explanation:
      "Significa 'como se dissesse' ou 'como se quisesse mostrar'. Expressa que a ação de alguém dá a entender algo, sem que seja explicitamente dito.",
  ...
  },
  {
    title: "〜に即して",
    explanation:
      "De acordo com, em conformidade com. Usado para indicar que algo está em linha com uma regra, realidade ou situação.",
    pattern: "名詞 ＋ に即して",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜に至るまで",
    explanation:
      "Até mesmo (chegar a um ponto extremo). Expressa que algo abrange um grande escopo, incluindo um item específico ou um ponto extremo.",
    pattern: "名詞 ＋ に至るまで",
    level: "N2",
    examples: [
      {
        ...
        romaji:
          "Kanojo wa ryōri no junbi kara katazuke ni itaru made, subete o hitori de konashita.",
  ...
  },
  {
    title: "〜を余儀なくされる",
    explanation:
      "Ser forçado a, ser obrigado a. Indica que uma situação força alguém a fazer algo contra sua vontade.",
    pattern: "名詞 ＋ を余儀なくされる",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を皮切りに（して）",
    explanation:
      "Começando com, tomando (algo) como ponto de partida. Indica o início de uma série de eventos ou ações.",
    pattern: "名詞 ＋ を皮切りに（して）",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を他所に",
    explanation:
      "Ignorando, sem se importar com (a situação alheia). Sinônimo de 〜をよそに, enfatiza o distanciamento da situação.",
    pattern: "名詞 ＋ を他所に",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を顧みず",
    explanation:
      "Sem se importar com, sem levar em conta. Usado quando alguém faz algo sem considerar as consequências ou o perigo.",
    pattern: "名詞 ＋ を顧みず",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜を踏まえて",
    explanation:
      "Com base em, levando em consideração. Indica que uma decisão ou ação é tomada após analisar uma situação ou informação.",
    pattern: "名詞 ＋ を踏まえて",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜はさておき",
    explanation:
      "Deixando de lado, para não falar de. Indica que um tópico é deixado de lado momentaneamente para focar em outro.",
    pattern: "名詞 ＋ はさておき",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜はともかく（として）",
    explanation:
      "Independentemente de, deixando de lado. Similar a 〜はさておき, mas pode ter um tom mais de 'não é tão importante quanto'.",
  ...
  },
  {
    title: "〜は否めない",
    explanation:
      "É inegável que, não se pode negar que. Expressa a certeza de que algo é verdade, mesmo que possa ser negativo.",
    pattern: "普通形 ＋ は否めない",
    level: "N2",
    examples: [
      {
  ...
  },
  {
    title: "〜ばこそ",
    explanation:
      "É precisamente porque (causa forte). Enfatiza fortemente a razão ou motivo para uma ação ou resultado.",
  ...
  },
  {
    title: "〜てやまない",
    explanation:
      "Expressa um desejo ou sentimento forte e contínuo, sem cessar. Indica que o falante sente aquilo profundamente.",
    pattern: "動詞て形 + やまない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜まみれ",
    explanation:
      "Indica que algo está completamente coberto ou sujo com a coisa especificada. Geralmente usado para coisas indesejáveis ou negativas.",
    pattern: "名詞 + まみれ",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜にあたって / にあたり",
    explanation:
      "Significa 'ao fazer', 'por ocasião de'. Usado para indicar uma ocasião ou oportunidade importante, geralmente formal.",
  ...
  },
  {
    title: "〜をものともせずに",
    explanation:
      "Significa 'desafiando', 'apesar de'. Indica que alguém faz algo com grande dificuldade ou obstáculo, sem se deixar abater.",
    pattern: "名詞 + をものともせずに",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜にかこつけて",
    explanation:
      "Significa 'sob o pretexto de', 'usando como desculpa'. Indica que alguém usa um motivo aparente para fazer algo, geralmente com segundas intenções.",
    pattern: "名詞 + にかこつけて",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜とあっては",
    explanation:
      "Significa 'se for o caso de', 'dado que'. Expressa que, em uma situação particular, não há outra opção a não ser agir de uma certa forma.",
    pattern: "普通形 + とあっては",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜と相まって",
    explanation:
      "Significa 'combinado com', 'juntamente com'. Indica que duas coisas se unem para criar um efeito ou resultado específico.",
    pattern: "名詞 + と相まって",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜につけ",
    explanation:
      "Significa 'toda vez que', 'sempre que'. Indica que um certo evento ou sentimento ocorre sempre que uma determinada situação acontece.",
  ...
  },
  {
    title: "〜にひきかえ",
    explanation:
      "Significa 'em contraste com', 'em oposição a'. Usado para comparar duas situações e enfatizar a diferença.",
  ...
  },
  {
    ...
    explanation:
      "Significa 'ser forçado a' (余儀なくされる) ou 'forçar a' (余儀なくさせる). Indica que não há outra escolha a não ser fazer algo, devido a uma situação externa.",
  ...
  },
  {
    title: "〜もさることながら",
    explanation:
      "Significa 'não só... mas também', 'embora... seja verdade, o mais importante é'. Indica que um item é importante, mas outro é ainda mais.",
    pattern: "名詞 + もさることながら",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜ごとき / 〜ごとく",
    explanation:
      "Significa 'como' ou 'assim como', geralmente usado para comparações poéticas ou formais. Também pode ser pejorativo.",
  ...
  },
  {
    title: "〜ならいざしらず",
    explanation:
      "Significa 'se fosse... até entenderia, mas...', indicando que uma situação é aceitável, mas outra não.",
  ...
  },
  {
    title: "〜までもない / 〜までもなく",
    explanation:
      "Significa 'não há necessidade de' ou 'sem a necessidade de', indicando que algo é óbvio ou desnecessário.",
  ...
  },
  {
    title: "〜ていては",
    explanation:
      "Significa 'se continuar fazendo isso, não será bom' ou 'se essa situação persistir...', expressando uma condição negativa e as suas consequências.",
    pattern: "動詞て形 + いては",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜こととて",
    explanation:
      "Significa 'porque (é a situação de)', 'já que', usado para dar uma razão ou desculpa de forma um pouco mais formal.",
  ...
  },
  {
    title: "〜と言わず〜と言わず",
    explanation:
      "Significa 'não importa A ou B', 'tanto A quanto B', indicando que algo se aplica a uma variedade de coisas, abrangendo extremos.",
  ...
  },
  {
    title: "〜べくして",
    explanation:
      "Significa 'como era de se esperar', 'naturalmente', indicando que um resultado era inevitável ou predestinado.",
  ...
  },
  {
    title: "〜でなくてなんだろう",
    explanation:
      "Significa 'o que mais poderia ser senão...?', expressando que algo é definitivamente uma determinada coisa, sem dúvida.",
  ...
  },
  {
    title: "〜といったらありはしない",
    explanation:
      "Significa 'é extremamente', 'não há limite para', usado para expressar um grau extremo de uma qualidade ou sentimento negativo.",
  ...
  },
  {
    title: "〜にしては",
    explanation:
      "Significa 'para ser...', 'considerando que é...', expressando que algo é inesperado em relação à sua condição ou característica.",
  ...
  },
  {
    title: "〜に至って / 〜に至っては",
    explanation:
      "Significa 'quando a situação chegou a...', 'quando a coisa chegou a esse ponto', indicando um estágio final ou crítico.",
  ...
  },
  {
    title: "〜を限りに",
    explanation:
      "Significa 'até o limite de', 'no último... de', indicando o fim de um período ou o último momento de algo.",
  ...
  },
  {
    title: "〜たるもの",
    explanation:
      "Significa 'como alguém que é X', 'se você é X', indicando a qualidade ou responsabilidade esperada de tal pessoa.",
    pattern: "名詞 + たるもの",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜に足らない",
    explanation:
      "Significa 'não é suficiente para X', 'não vale a pena X'. É o oposto de 〜に足りる.",
  ...
  },
  {
    title: "〜を余儀なくされる / 〜を余儀なくさせる",
    explanation:
      "Significa 'ser forçado a X', 'ser obrigado a X' (ser). A forma 'させる' significa 'forçar X a alguém'.",
  ...
  },
  {
    title: "〜ないまでも",
    explanation:
      "Significa 'mesmo que não chegue a X', 'se não for X, pelo menos Y'. Indica um limite ou um mínimo aceitável.",
    pattern: "動詞ない形 + までも",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜とあって",
    explanation:
      "Significa 'como era X', 'visto que era X'. Apresenta uma razão ou circunstância especial que leva a uma determinada situação.",
  ...
  },
  {
    title: "〜をおして",
    explanation:
      "Significa 'apesar de X', 'contrariando X'. Indica que algo é feito contra uma condição desfavorável ou uma regra.",
    pattern: "名詞 + をおして",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜だに",
    explanation:
      "Significa 'até mesmo X', 'apenas X já'. Enfatiza que uma pequena ação ou menção de algo já é suficiente para causar uma emoção ou efeito.",
    pattern: "動詞辞書形 / 名詞 + だに",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜べくもない",
    explanation:
      "Significa 'não há como X', 'não é possível X'. Expressa que uma ação ou situação é impossível ou altamente improvável.",
    pattern: "動詞辞書形 + べくもない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜かたがた",
    explanation:
      "Significa 'aproveitando a oportunidade para X', 'fazendo X e Y ao mesmo tempo'. Indica que se realiza uma ação e, no mesmo processo, outra.",
    pattern: "名詞 + かたがた",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜ともなると / 〜ともなれば",
    explanation:
      "Significa 'quando se trata de X', 'se chegar a X'. Indica que uma situação muda ou se torna mais séria ou complexa ao atingir um certo nível ou estágio.",
  ...
  },
  {
    title: "〜なり",
    explanation:
      "Significa 'assim que/logo que (aconteceu)', indicando uma ação imediata após outra, ou 'fazer algo como (se fosse) um (determinado) estado'. Também pode indicar 'seja (isto) ou seja (aquilo)'.",
  ...
  },
  {
    title: "〜まじき",
    explanation:
      "Significa 'não deve ser (tal coisa)' ou 'imperdoável para (tal coisa)'. Expressa um forte sentimento de que algo é inapropriado ou inaceitável para uma determinada pessoa ou situação.",
  ...
  },
  {
    title: "〜に足りない",
    explanation:
      "Significa 'não vale a pena (fazer/considerar)' ou 'não é suficiente para'. Indica que algo não tem valor ou peso para ser levado em conta.",
  ...
  },
  {
    title: "〜にはあたらない",
    explanation:
      "Significa 'não é necessário/não se aplica a', indicando que algo não é digno de uma determinada reação ou consideração.",
  ...
  },
  {
    title: "〜を余儀なくされる／余儀なくさせる",
    explanation:
      "Significa 'ser forçado a (fazer algo)' (れる) ou 'forçar alguém a (fazer algo)' (させる). Indica que uma circunstância externa levou a uma ação inevitável.",
    pattern: "名詞＋を余儀なくされる／余儀なくさせる",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜に則って",
    explanation:
      "Similar a '〜に即して', mas enfatiza seguir uma regra, princípio ou tradição. 'Seguindo/em conformidade com (regra/princípio)'.",
    pattern: "名詞＋に則って",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜を振り出しに",
    explanation:
      "Significa 'começando com (algo)/tendo (algo) como ponto de partida'. Indica o início de uma série de eventos ou ações.",
    pattern: "名詞＋を振り出しに",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜なり〜なり",
    explanation:
      'Significa "seja X ou seja Y", oferecendo opções ou alternativas, geralmente com uma sugestão de que qualquer uma delas servirá.',
    ...
    examples: [
      {
        ...
        romaji:
          "Wakaranai koto ga attara, sensei ni kiku nari, tomodachi ni kiku nari shite kudasai.",
  ...
  },
  {
    title: "〜なりに／なりの",
    explanation:
      'Significa "à sua maneira", "dentro dos seus limites" ou "no seu próprio estilo", indicando que algo é feito de forma particular ou limitada a certas condições.',
  ...
  },
  {
    title: "〜てからというもの",
    explanation:
      'Significa "desde que X aconteceu, Y tem acontecido consistentemente", indicando uma mudança significativa que ocorreu e tem continuado desde um certo ponto no tempo.',
    pattern: "Vて + からというもの",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜であろうと／であろうが",
    explanation:
      'Significa "seja X ou não", "não importa se X", indicando que uma condição ou situação não afeta o resultado ou a conclusão.',
  ...
  },
  {
    title: "〜に堪えない",
    explanation:
      'Significa "não poder suportar", "não poder aguentar", expressando que algo é tão intenso ou doloroso que não pode ser suportado.',
    pattern: "N + に堪えない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜に堪える",
    explanation:
      'Significa "ser digno de", "merecer", indicando que algo é bom o suficiente para suportar ou ser submetido a uma determinada ação.',
    pattern: "N + に堪える",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜を強いられる",
    explanation:
      'Significa "ser forçado a" ou "ser compelido a fazer X", indicando que alguém é obrigado a suportar algo difícil ou fazer algo contra sua vontade.',
    pattern: "N + を強いられる",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜に忍びない",
    explanation:
      'Significa "não ter coragem de fazer X" ou "não suportar fazer X", expressando que se sente tão mal que não consegue realizar uma ação.',
    pattern: "V辞書形 + に忍びない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜に至って",
    explanation:
      "Expressa que uma situação chegou a um ponto extremo ou a um resultado inesperado, muitas vezes negativo, e que uma ação foi finalmente tomada.",
  ...
  },
  {
    title: "〜に至っては",
    explanation:
      "Utilizado para destacar um exemplo extremo ou surpreendente dentro de um grupo, mostrando que a situação é ainda mais notável ou pior para esse caso específico.",
    pattern: "名詞＋に至っては",
    level: "N1",
    examples: [
      {
        ...
        romaji:
          "Saikin no wakamono wa dokusho banare ga susunde iru. Manga ni itatte wa, hotondo yomanai sō da.",
  ...
  },
  {
    title: "〜てまえ",
    explanation:
      "Significa que, devido a uma situação específica (um compromisso, a presença de alguém, etc.), não se pode deixar de fazer algo ou não se pode agir de determinada maneira.",
  ...
  },
  {
    title: "〜の感をぬぐえない",
    explanation:
      "Significa que não se pode apagar ou remover a sensação de que algo é verdade, mesmo que se tente negá-lo, geralmente uma sensação negativa.",
    pattern: "名詞＋の感をぬぐえない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜がてら",
    explanation:
      "Significa 'aproveitando para...', indicando que se faz algo principal e, ao mesmo tempo, outra coisa secundária.",
  ...
  },
  {
    title: "〜まかり通る",
    explanation:
      "Significa 'passar livremente', 'ser aceito sem restrições', muitas vezes com uma conotação negativa de algo indesejável que prevalece.",
    pattern: "名詞＋が＋まかり通る",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜といい",
    explanation:
      "Indica que algo é bom de determinada maneira, ou que seria bom que algo acontecesse.",
    pattern: "普通形 + といい",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜とはいえ",
    explanation:
      "Embora; apesar de. Expressa uma concessão, muitas vezes com uma nuance de contra-expectativa.",
    pattern: "普通形 + とはいえ",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜とみるや",
    explanation:
      "Assim que; tão logo. Indica que uma ação é realizada imediatamente após observar ou perceber algo.",
    pattern: "動詞辞書形 + とみるや",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜には及ばない",
    explanation:
      "Não precisa; não há necessidade. Indica que algo não é necessário ou que não atinge um certo nível.",
  ...
  },
  {
    title: "〜の極みだ",
    explanation:
      "O extremo de; o ápice de. Semelhante a 〜の至りだ, expressa o ponto máximo de algo, geralmente negativo.",
    pattern: "名詞 + の極みだ",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜の他ならない",
    explanation:
      "Não é nada além de; nada mais que. Enfatiza que algo é puramente uma determinada coisa e nada mais.",
    pattern: "名詞 + の他ならない",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜がまかり通る",
    explanation:
      "Passar livremente; ser aceito sem questionamento. Expressa que algo, geralmente negativo ou irracional, é permitido ou comum em uma situação.",
    pattern: "名詞 + がまかり通る",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜ばそれまでだ",
    explanation:
      "Se isso acontecer, então é o fim; não há mais nada a fazer. Expressa que se uma condição for cumprida, tudo se torna inútil ou sem sentido.",
  ...
  },
  {
    title: "〜をものともせず(に)",
    explanation:
      "Desafiando; sem se importar com; superando. Indica que alguém realiza algo difícil ou perigoso sem se deixar abater por obstáculos.",
  ...
  },
  {
    title: "〜ともなると",
    explanation:
      "Quando chega a; quando se torna. Indica que, ao atingir um certo nível, idade ou estágio, uma situação ou comportamento muda ou se torna aparente.",
    pattern: "名詞＋ともなると",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜にかなう",
    explanation:
      "Estar de acordo com; ser adequado para; satisfazer. Usado para expressar que algo se encaixa em um padrão, expectativa ou desejo.",
    pattern: "名詞＋にかなう",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜にたえる",
    explanation:
      "Ser digno de; valer a pena; suportar. Indica que algo tem a qualidade ou resistência necessária para uma determinada finalidade ou para suportar algo.",
    pattern: "名詞＋にたえる",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜かと思いきや",
    explanation:
      "Significa 'pensei que seria..., mas na verdade foi o oposto', expressando uma surpresa ou decepção com o resultado.",
  ...
  },
  {
    title: "〜べく",
    explanation:
      "Significa 'a fim de', 'com o propósito de', indicando uma intenção ou objetivo. É uma expressão formal e literária.",
  ...
  },
  {
    title: "〜からある",
    explanation:
      "Significa 'pelo menos...', 'e mais', indicando que um número é grande ou significativo, muitas vezes superando as expectativas.",
    pattern: "数詞＋からある",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜といったら（ありゃしない）",
    explanation:
      "Expressa uma intensidade extrema de um sentimento ou estado negativo, algo que não pode ser superado.",
  ...
  },
  {
    title: "〜にしたところで",
    explanation:
      "Significa 'mesmo que seja...', 'mesmo no caso de...', indicando que mesmo considerando uma certa pessoa ou situação, o resultado não muda.",
    pattern: "名詞＋にしたところで",
    level: "N1",
    examples: [
      {
  ...
  },
  {
    title: "〜をおいて",
    explanation:
      "Significa 'exceto por...', 'tirando...', 'apenas...', expressando que ninguém ou nada mais pode ser comparado ou é adequado para a situação.",
    pattern: "名詞＋をおいて",
    level: "N1",
    examples: [
      {
